...
function getHomedLink(configuration){
    getHomedPort(configuration);
    return location.protocol+'//'+location.host+':'+homedPort+'/';
}
return view.extend({
    load:function(){
    ...
    handleSave:function(ev){
        ...
        return fs.write('/etc/homed/homed-web.conf',value).then(function(rc){
            ...
            document.querySelector('#homedLink').href=getHomedLink(value);
    ...
    render:function(configuration){
        ...
        return E([
            ...
            E('p',{'class':'cbi-section-descr'},_('Documentation can be found <a href="https://wiki.homed.dev/web/configuration" target="_blank">here</a>.' + (homedPort?'<br><a id="homedLink" href="'+getHomedLink(configuration)+'" target="_blank">Open</a> HOMEd Web.':''))),
