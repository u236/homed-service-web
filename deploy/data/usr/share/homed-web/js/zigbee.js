class ZigBee extends DeviceService
{
    ...
    showPage(data)
    {
        ...
        menu.querySelector('#permitJoin').addEventListener('click', function() { menu.querySelector('#permitJoin i').className = 'mdi-power-standby'; this.serviceCommand({action: 'togglePermitJoin'}); }.bind(this));
