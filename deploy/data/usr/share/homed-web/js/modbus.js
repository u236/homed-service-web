class Modbus extends DeviceService
{
    deviceType =
    {
        ...
        kc868a4:               'Kincony KC868-A4 Controller',
        kc868a6:               'Kincony KC868-A6 Controller',
        kc868a8:               'Kincony KC868-A8 Controller',
        kc868a16:              'Kincony KC868-A16 Controller',
    ...
    showDeviceList()
    {
        ...
        loadHTML('html/modbus/deviceList.html', this, this.content, function()
        {
            ...
            table.querySelectorAll('th.sort').forEach(cell => cell.addEventListener('click', function() { sortTable(table, this.dataset.index); localStorage.setItem('homedModbusSort', this.dataset.index); }) );
            sortTable(table, localStorage.getItem('homedModbusSort') ?? 0);
